...
| Role     | Email                                           | Password      |
| -------- | ----------------------------------------------- | ------------- |
| Admin    | [nawazish@gmail.com](mailto:nawazish@gmail.com) | admin@macbook |
| Tenant   | [tenant@demo.com](mailto:tenant@demo.com)       | demo123       |
| Tenant 2 | [tenant2@demo.com](mailto:tenant2@demo.com)     | demo123       |
...
- **Frontend**: [https://rentease.vercel.app](https://rentease.vercel.app) *(update after deploy)*
- **Backend API**: [https://rentease-api.onrender.com](https://rentease-api.onrender.com) *(update after deploy)*
